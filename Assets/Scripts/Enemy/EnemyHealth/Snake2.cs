...
public class Snake2 : MonoBehaviour
{
    ...
    private EnemySpawner spawnerSnake2; // 몬스터마다 수정
    ...
    private void Awake()
    {
        ...
        spawnerSnake2 = GameObject.FindWithTag("BrownSnakeSpawner").GetComponent<EnemySpawner>();
    ...
    public void Dead() // 죽었을 때 실행
    {
        ...
        Destroy(gameObject);
        --spawnerSnake2.enemyCount;
        spawnerSnake2.timer = 0;        
