...
public class Deer1 : MonoBehaviour
{
    ...
    private EnemySpawner spawnerDeer1; // 몬스터마다 수정
    ...
    private void Awake()
    {
        ...
        spawnerDeer1 = GameObject.FindWithTag("DeerSpawner").GetComponent<EnemySpawner>();
    ...
    public void Dead() // 죽었을 때 실행
    {
        ...
        Destroy(gameObject);
        --spawnerDeer1.enemyCount;
        spawnerDeer1.timer = 0;
