...
public class Deer2 : MonoBehaviour
{
    ...
    private EnemySpawner spawnerDeer2; // 몬스터마다 수정
    ...
    private void Awake()
    {
        ...
        spawnerDeer2 = GameObject.FindWithTag("FlowerDeerSpawner").GetComponent<EnemySpawner>();
    ...
    public void Dead() // 죽었을 때 실행
    {
        ...
        Destroy(gameObject);
        --spawnerDeer2.enemyCount;
        spawnerDeer2.timer = 0;
