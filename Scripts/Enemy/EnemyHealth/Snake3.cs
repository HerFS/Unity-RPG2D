...
public class Snake3 : MonoBehaviour
{
    ...
    private EnemySpawner spawnerSnake3; // 몬스터마다 수정
    ...
    private void Awake()
    {
        ...
        spawnerSnake3 = GameObject.FindWithTag("BlueSnakeSpawner").GetComponent<EnemySpawner>();
    ...
    public void Dead() // 죽었을 때 실행
    {
        ...
        Destroy(gameObject);
        --spawnerSnake3.enemyCount;
        spawnerSnake3.timer = 0;
