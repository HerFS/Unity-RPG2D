...
public class Camel : MonoBehaviour
{
    ...
    private EnemySpawner spawnerCamel; // 몬스터마다 수정
    ...
    private void Awake()
    {
        ...
        spawnerCamel = GameObject.FindWithTag("CamelSpawner").GetComponent<EnemySpawner>();
    ...
    public void Dead() // 죽었을 때 실행
    {
        ...
        Destroy(gameObject);
        --spawnerCamel.enemyCount;
        spawnerCamel.timer = 0;
