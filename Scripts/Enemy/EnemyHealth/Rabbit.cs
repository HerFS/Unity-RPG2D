...
public class Rabbit : MonoBehaviour
{
    ...
    private EnemySpawner spawnerRabbit; // 몬스터마다 수정
    ...
    private void Awake()
    {
        ...
        spawnerRabbit = GameObject.FindWithTag("RabbitSpawner").GetComponent<EnemySpawner>();
    ...
    public void Dead() // 죽었을 때 실행
    {
        ...
        Destroy(gameObject);
        --spawnerRabbit.enemyCount;
        spawnerRabbit.timer = 0;
